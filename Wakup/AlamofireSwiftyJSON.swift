...
extension Request {
    ...
    /**
     ...
     :returns: The request.
     */
    public func responseSwiftyJSON(_ completionHandler: (NSURLRequest, NSHTTPURLResponse?, JSON, ErrorType?) -> Void) -> Self {
    ...
    /**
     ...
     :returns: The request.
     */
    public func responseSwiftyJSON(_ queue: dispatch_queue_t? = nil, options: NSJSONReadingOptions = .AllowFragments, completionHandler: (NSURLRequest, NSHTTPURLResponse?, JSON, ErrorType?) -> Void) -> Self {
